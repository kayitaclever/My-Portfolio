            ...
            <div className='grid lg:grid-cols-5 gap-8'>
                ...
                <div className='col-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4'>
                    <div className='lg:p-4 h-full'>
                        <div>
                            <Image className="rounded-xl hover:scale-105 ease-in duration-300" src="/assets/contact.jpg" alt="/" width="640" height="247" />
                        </div>
                        <div>
                            <h2 className='py-2 uppercase'>Clever Kayitaramirwa</h2>
                        ...
                        <div>
                            ...
                            <div className='flex items-center justify-between py-4'>
                                ...
                                <div className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-default hover:scale-110 ease-in duration-300">
                                    <a href='mailto:kayitaramirwaaclever@gmail.com' target='_blank'><AiOutlineMail/></a>
                                </div>
                                <div className="rounded-full shadow-lg shadow-gray-400 p-6 cursor-default hover:scale-110 ease-in duration-300">
